                ...
                >
                  <div
                    style={{
                      display: 'flex',
                      alignItems: 'center',
                      justifyContent: 'center', // 添加居中样式
                      backgroundColor: group.every(d => d.status === 'normal') ? 'green' : 'red',
                      color: 'white',
                      padding: '12px 16px',
                      margin: '5px',
                      cursor: 'pointer',
                    ...
                    // onClick={() => handleDeviceClick(group[0].id)}
                  >
                    <div style={{ display: 'flex', width: '100%' }}>
                      {group.map((d, idx) => (
                        <div key={d.id} 
                          // style={{ flex: 1, borderRight: idx === 0 ? '1px solid white' : 'none', padding: '0 3px' }}
                          style={{
                            flex: 1,
