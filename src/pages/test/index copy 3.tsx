...
export default function ClusterInfo() {
  ...
  const mockDevices = [
    { id: '1', name: 'esw', rack: 'C01',type:'switch', status: 'normal' },
    { id: '2', name: 'gisw', rack: 'C01',type:'switch', status: 'normal' },
    { id: '3', name: 'cn07&08', rack: 'C01', type:'server', status: 'normal' },
    { id: '4', name: 'cn05&06', rack: 'C01', type:'server', status: 'normal' },
    { id: '5', name: 'cn03&cn04', rack: 'C01', type:'server', status: 'normal' },
    { id: '6', name: 'cn01', rack: 'C01', type:'server', status: 'normal' },
    { id: '7', name: 'cn02', rack: 'C01', type:'server', status: 'normal' },
    { id: '8', name: 'mn01', rack: 'C01', type:'server', status: 'normal' },
    { id: '9', name: 'matlab', rack: 'C01', type:'server', status: 'normal' },
    { id: '10', name: 'dtsw', rack: 'C02', type:'switch', status: 'normal' },
    { id: '11', name: 'gosw', rack: 'C02', type:'switch', status: 'normal' },
    { id: '12', name: 'cn15&cn16', rack: 'C02', type:'server', status: 'normal' },
    { id: '13', name: 'cn13&cn14', rack: 'C02', type:'server', status: 'normal' },
    { id: '14', name: 'cn11&cn12', rack: 'C02', type:'server', status: 'normal' },
    { id: '15', name: 'cn09&cn10', rack: 'C02', type:'server', status: 'normal' },
    { id: '16', name: 'mn02', rack: 'C02', type:'server', status: 'normal' },
    { id: '17', name: 'io', rack: 'C02', type:'server', status: 'error' },
  ];
  ...
  const renderRack = (rackId: string) => {
    ...
    .filter(device => device.name !== 'cn02'); // 过滤单独的 cn02;
    return (
            ...
            title={
              device.name === 'cn01' ? (
                <div style={{
                  ...
                  <p style={{ margin: 0, color: '#595959' }}>设备名称: cn01</p>
                  <p style={{ margin: 0, color: 'green' }}>状态: normal</p>
                  <p style={{ margin: 0, color: '#595959' }}>设备名称: cn02</p>
                  <p style={{ margin: 0, color: 'green' }}>状态: normal</p>
                </div>
              ) : (
                <div style={{
          ...
          >
            <div
              style={{
                ...
                color: 'white',
                padding: device.type === 'switch' ? '6px 16px' : '12px 16px',
                margin: '5px',
                cursor: 'pointer',
                borderRadius: 8,
                fontSize: 14,
            ...
            >
              {device.name === 'cn01' ? (
                <div style={{ display: 'flex', width: '100%' }}>
                  <div style={{ flex: 1, borderRight: '1px solid white', padding: '0 3px' }}>cn01</div>
                  <div style={{ flex: 1, padding: '0 3px' }}>cn02</div>
                </div>
              ) : device.name}
            </div>
          </Tooltip>
  ...
  width: 300, // 保持与右侧指标模块相同宽度
  border: '1px solid #e8e8e8',
  borderRadius: 12,
  padding: '32px', // 与其它模块保持一致内边距
  ...
  <h2 style={{ 
    ...
    <div style={{
      ...
      bottom: 4,
      width: 4,
      backgroundColor: '#2f54eb', // 统一蓝色标识色
      borderRadius: 2
    }} />
    设备状态
  </h2>
  <div style={{ 
    ...
    flexWrap: 'nowrap', // 修改：强制并排显示（原为wrap）
    gap: '20px',
    marginTop: 24 
}}>
  {renderRack('C01')}
